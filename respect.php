...
?>
    ...
    <head>
        ...
        <title>Respect des engagements de service | Dekap Lah</title>
                    ...
                    <div class="container-fluid px-4">
                        <div class="card m-5">
                            <div class="card-header">
                                <h3 class="m-4">Respect des engagements de service</h3>
                            </div>
                            <table class="m-4">
                                <form method="post">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="nature" name="nature">
                                                <option value="Respect des engagements de service">Respect des engagements de service</option>
                                            </select></td>
                                    </tr>
                                    <tr>
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="intitule_obj" name="intitule_obj">
                                                <option value="">-----</option>
                                                <option value="Délais de transmission des dossiers à la DDE">Délais de transmission des dossiers à la DDE</option>
                                                <option value="Visites clients">Visites clients</option>
                                              </select></td>
                                    </tr>
                                    <tr>
    ...
    var objectifs = {
        "Délais de transmission des dossiers à la DDE": [
            "Nombre de dossiers traités dans les délais",

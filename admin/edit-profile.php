...
if($msg)
{
    echo "<script>alert('Profil modifiée avec succès!');</script>";
...
<html lang="en">
    <head>
        ...
        <title>Modifier Profil | Insert Pro</title>
...
{?>
                        <h1 class="mt-4">Informations Personnelles de <?php echo $result['fname'];?></h1>
                        <div class="card mb-4">
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       ...
                                       <td><input class="form-control" id="lname" name="lname" type="text" value="<?php echo $result['lname'];?>"  required /></td>
                                         ...
                                         <tr>
                                       <th>Numéro de tel</th>
                                       <td colspan="3"><input class="form-control" id="contact" name="contact" type="text" value="<?php echo $result['contactno'];?>"  pattern="6[0-9]{8}" title="08 chiffres"  required /></td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="update">Mettre à jour</button></td>

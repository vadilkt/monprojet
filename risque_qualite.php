...
?>
    ...
    <head>
        ...
        <title>Gestion du risque et de la qualité du portefeuille | Dekap Lah</title>
                    ...
                    <div class="container-fluid px-4">
                        <div class="card m-5">
                            <div class="card-header">
                                <h3 class="m-4">Gestion du risque et de la qualité du portefeuille</h3>
                            </div>
                            <table class="m-4">
                                <form method="post">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="nature" name="nature">
                                                <option value="Gestion du risque et de la qualité du portefeuille">Gestion du risque et de la qualité du portefeuille</option>
                                            </select></td>
                                    </tr>
                                    <tr>
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="intitule_obj" name="intitule_obj">
                                                <option value="">-----</option>
                                                <option value="Suivi des forçages">Suivi des forçages</option>
                                                <option value="Suivi des engagements irréguliers(anomalies)">Suivi des engagements irréguliers(anomalies)</option>
                                                <option value="Suivi des engagements douteux(anomalies)">Suivi des engagements douteux(anomalies)</option>
                                                <option value="Suivi des recouvrements">Suivi des recouvrements</option>
                                               </select></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="moyen" name="moyen">
                                                <option value="">-----</option>
                                                <option value="Etat des forçages">Etat des forçages</option>
                                                <option value="Etat des comptes en anomalie">Etat des comptes en anomalie</option>
                                                <option value="Etat des crénaces douteuses">Etat des crénaces douteuses</option>
                                                <option value="Etat des comptes déclassés">Etat des comptes déclassés</option>
                                            </select></td>
                                    </tr>
    ...
    var objectifs = {
        "Suivi des forçages": [
            "Nombre de forçage régularisé dans les délais",
            "Nombre de forçage"
        ],
        "Suivi des engagements irréguliers(anomalies)": [
            "Nombre de compte en anomalie",
            "Nombre total des clients engagés"
        ],
        "Suivi des engagements douteux(anomalies)": [
            "Total encours douteux",
            "Total engagements"
        ],
        "Suivi des recouvrements": [
            "Montant total recouvré",
            "Total PTF douteux au 31/12/2021"
        ]

...
<html lang="en">
    <head>
        ...
        <title>Changer de mot de passe| Insert Pro</title>
...
{
alert("Confirmation de mot de passe échouée  !!");
                     ...
                     <form method="post" name="changepassword" onSubmit="return valid();">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="update">Changer</button></td>

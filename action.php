...
?>
    ...
    <head>
        ...
        <title>Action Commerciale | Dekap Lah</title>
                    ...
                    <div class="container-fluid px-4">
                        <div class="card m-5">
                            <div class="card-header">
                                <h3 class="m-4">Action commerciale</h3>
                            </div>
                            <table class="m-4">
                                <form method="post">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="intitule_obj" name="intitule_obj">
                                                <option value="">-----</option>
                                                <option value="Taux de transformation des prospects en clients">Taux de transformation des prospects en clients</option>
                                                <option value="Entrée en Relation">Entrée en Relation</option>
                                                <option value="Conformité des formulaires à remplir et des documents à fournir">Conformité des formulaires à remplir et des documents à fournir</option>
                                            </select></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><select class="form-select" id="moyen" name="moyen">
                                                ...
                                                <option value="Dotation carburant">Dotation carburant</option>
                                            </select></td>
                                    </tr>
